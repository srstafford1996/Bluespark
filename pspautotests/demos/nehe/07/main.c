//From cygwin version of Nehe tutorial lesson 7
...
//    usleep(100); @@@
    ...
    switch (key) {    
// those controls are moved in triggerPressed
/*    case GLUT_KEY_PAGE_UP: // move the cube into the distance.
	...
	break;
*/
    case GLUT_KEY_UP: // decrease x rotation speed;   @@@ PAD UP
		xspeed-=0.1f;
	break;

    case GLUT_KEY_DOWN: // increase x rotation speed;   @@@ PAD DOWN
		xspeed+=0.1f;
	break;

    case GLUT_KEY_LEFT: // decrease y rotation speed;   @@@ PAD LEFT
		yspeed-=0.1f;
	break;
    
    case GLUT_KEY_RIGHT: // increase y rotation speed;   @@@ PAD RIGHT
		yspeed+=0.1f;
	break;
