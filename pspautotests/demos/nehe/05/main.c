//From cygwin version of Nehe tutorial lesson 5
...
// @@@ so we need a glEnd() for each Quad in oder to have the right shape
  ...
  rtri+=1.50f;					// Increase The Rotation Variable For The Pyramid
  rquad-=1.50f;					// Decrease The Rotation Variable For The Cube
